...
class CategoryRepo {
  ...
  Future<Response> getSubCategoryList2(String parentID) async {
    return await apiClient
        .getData('${AppConstants.SUB_CATEGORY_URI2}$parentID');
  }

  Future<Response> getCategoryProductList(
      String categoryID, String offset) async {
    return await apiClient.getData(
        '${AppConstants.CATEGORY_PRODUCT_URI}$categoryID?limit=10&offset=$offset');
  }
