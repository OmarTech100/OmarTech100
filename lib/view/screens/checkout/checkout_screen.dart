  ...
  void initState() {
    ...
    if (_isLoggedIn) {
      ...
      Get.find<RestaurantController>().getRestaurantDetails(
          Restaurant(id: _cartList[0].product.restaurantId));
    }
  }
          ...
          ? GetBuilder<RestaurantController>(builder: (restController) {
              if (restController.restaurant != null) {
                ...
                if (restController.restaurant.openingTime != null) {
                  DateTime _open = DateConverter.convertStringTimeToDate(
                      restController.restaurant.openingTime);
                  DateTime _close = DateConverter.convertStringTimeToDate(
                ...
                Get.find<OrderController>().getDistanceInMeter(
                  ...
                  LatLng(double.parse(restController.restaurant.latitude),
                      double.parse(restController.restaurant.longitude)),
                );
              }
              return GetBuilder<CouponController>(builder: (couponController) {
                return GetBuilder<OrderController>(builder: (orderController) {
                  ...
                  if (orderController.distance != null) {
                    ...
                    if (orderController.distance == 1) {
                      _deliveryCharge = Get.find<SplashController>()
                          .configModel
                          .minimumShippingCharge;
                      _charge = Get.find<SplashController>()
                          .configModel
                          .minimumShippingCharge; //araby
                    } else {
                      _charge = orderController.distance *
                          Get.find<SplashController>()
                              .configModel
                                      ...
                                      children: [
                                        ...
                                        restController.restaurant.delivery
                                            ? DeliveryOptionButton(
                                                ...
                                                charge: _deliveryCharge > 35.0
                                                    ? _deliveryCharge = 35.0
                                                    : _deliveryCharge,
