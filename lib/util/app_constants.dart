...
class AppConstants {
  static const String APP_NAME = 'Lines';
  static const String MAP_API_KEY = 'AIzaSyBfQ2rwMXb1oPLiyiCQ22vSZpwA2U43mzk';
  static const int APP_VERSION = 1;
  static const String BASE_URL = 'http://178.62.101.148';
  static const String CATEGORY_URI = '/api/v1/categories';
  static const String BANNER_URI = '/api/v1/banners';
  static const String RESTAURANT_PRODUCT_URI =
      '/api/v1/products/latest?restaurant_id=';
  ...
  static const String SUB_CATEGORY_URI2 = '/api/v1/categories/childern/';
